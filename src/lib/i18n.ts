...
const DE = {
  ...
  galleryLead:
    'Von der Community eingereicht und automatisch geprüft. Jedes Video läuft live aus seinen Daten. KI-recherchiert, Angaben ohne Gewähr; die Datensätze stehen unter CC BY-SA 4.0.',
  galleryFrom:
    'Aus der öffentlichen Galerie: KI-recherchiert und automatisch geprüft, Angaben ohne Gewähr.',
  galleryEmpty: 'Noch keine Einträge. Deiner kann der erste sein: im Studio unter „Galerie“ einreichen.',
  galleryLabel: 'KI-recherchiert · automatisch geprüft',
  galleryReport: 'Melden',
  reportTitle: 'Eintrag melden',
  reportLead:
    'Was stimmt nicht? Zum Beispiel falsche Zahlen, rechtswidrige oder beleidigende Inhalte oder verletzte Rechte. Der Eintrag wird sofort ausgeblendet und von einer KI nach den Galerie-Regeln neu geprüft.',
  ...
  reportRemoved: 'Automatisch geprüft: Der Eintrag wurde entfernt. {reason}',
  reportKept:
    'Automatisch geprüft: Der Eintrag verstößt nicht gegen die Galerie-Regeln und bleibt online. {reason}',
  reportPending: 'Danke. Der Eintrag ist ausgeblendet, bis er geprüft ist.',
  reportMailed: 'Die Entscheidung kommt auch per E-Mail.',
  reportDisagree: 'Nicht einverstanden oder etwas unklar? Schreib an',
  ...
  publishChecking: 'Wird geprüft …',
  publishApproved: 'Automatisch geprüft und öffentlich in der Galerie.',
  publishOpen: 'Ansehen',
  publishRejected: 'Automatisch abgelehnt: {reason}',
  publishRemoved: 'Entfernt: {reason}',
  publishReported: 'Gemeldet und ausgeblendet, bis die Prüfung abgeschlossen ist.',
  publishUnavailable: 'Die automatische Prüfung ist gerade nicht erreichbar. Versuch es später noch einmal.',
  ...
  modLead:
    'Eine KI entscheidet jede Einreichung und jede Meldung selbst. Hier lassen sich Entscheidungen stichprobenartig prüfen und überstimmen; Meldungen, deren Prüfung ausgefallen ist, warten hier.',
  modToken: 'Admin-Token',
  modLoad: 'Laden',
  modReports: 'Meldungen ({n} offen)',
  modRecent: 'Letzte Entscheidungen ({n})',
...
const EN: Record<MessageKey, string> = {
  ...
  galleryLead:
    'Submitted by the community and reviewed automatically. Every video plays live from its data. AI-researched, no guarantee of accuracy; the datasets are licensed CC BY-SA 4.0.',
  galleryFrom:
    'From the public gallery: AI-researched and reviewed automatically, no guarantee of accuracy.',
  galleryEmpty: 'No entries yet. Yours can be the first: submit it in the studio under “Gallery”.',
  galleryLabel: 'AI-researched · reviewed automatically',
  galleryReport: 'Report',
  reportTitle: 'Report this entry',
  reportLead:
    'What is wrong? For example wrong numbers, illegal or offensive content, or infringed rights. The entry is hidden at once and an AI reviews it again against the gallery rules.',
  reportReason: 'Reason',
  ...
  reportRemoved: 'Reviewed automatically: the entry has been removed. {reason}',
  reportKept:
    'Reviewed automatically: the entry does not break the gallery rules and stays online. {reason}',
  reportPending: 'Thanks. The entry is hidden until it has been reviewed.',
  reportMailed: 'You will also get the decision by email.',
  reportDisagree: 'Disagree or something unclear? Write to',
  reportLimit: 'You have used today’s reports. Write to us directly at business@moinsen.dev.',
  reportSend: 'Send report',
  close: 'Close',
  publishLead:
    'Show your video in the public gallery. Only the dataset is submitted: title, numbers, events, sources and the music parameters. No audio files, no keys, no personal data. An AI reviews the submission against the gallery rules right away and decides whether it appears.',
  publishRules: 'Gallery rules',
  publishRulesText:
    'Only content you may publish: nothing illegal, offensive or deliberately misleading, and no details about private individuals.\nNothing that demeans people for their origin, religion, gender, sexual orientation or disability, no glorified violence, no extremism, no sexual content, no election campaigning, no conspiracy theories.\nThe sources must allow publication. Open data such as Our World in Data or the World Bank fits; numbers behind paywalls such as Statista do not.\nAn AI reviews every submission right away and tells you here in the studio why, if it rejects one. Reported entries are hidden and reviewed again.\nThe entry appears with all its sources and a note that an AI researched and reviewed it.\nYou can withdraw your entry at any time; it is then deleted.',
  ...
  publishChecking: 'Reviewing …',
  publishApproved: 'Reviewed automatically and public in the gallery.',
  publishOpen: 'View',
  publishRejected: 'Rejected by the automatic review: {reason}',
  publishRemoved: 'Removed: {reason}',
  publishReported: 'Reported and hidden until the review is complete.',
  publishUnavailable: 'The automatic review is unavailable right now. Please try again later.',
  ...
  moderation: 'Moderation',
  modLead:
    'An AI decides every submission and every report on its own. Here you can spot-check and override decisions; reports whose review failed wait here.',
  modToken: 'Admin token',
  modLoad: 'Load',
  modReports: 'Reports ({n} open)',
  modRecent: 'Latest decisions ({n})',
  modApprove: 'Approve',
  modRemove: 'Remove',
  modView: 'View',
