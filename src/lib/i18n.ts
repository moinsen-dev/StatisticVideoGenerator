...
const DE = {
  ...
  galleryLead:
    'Von der Community eingereicht, von moinsen geprüft. Jedes Video läuft live aus seinen Daten. KI-recherchiert, Angaben ohne Gewähr; die Datensätze stehen unter CC BY-SA 4.0.',
  galleryFrom: 'Aus der öffentlichen Galerie: KI-recherchiert, von moinsen geprüft, Angaben ohne Gewähr.',
  galleryEmpty: 'Noch keine Einträge. Deiner kann der erste sein: im Studio unter „Galerie“ einreichen.',
  galleryLabel: 'KI-recherchiert · von moinsen geprüft',
  galleryReport: 'Melden',
  reportTitle: 'Eintrag melden',
  reportLead: 'Was stimmt nicht? Zum Beispiel falsche Zahlen, rechtswidrige oder beleidigende Inhalte oder verletzte Rechte. Wir prüfen jede Meldung.',
  reportReason: 'Begründung',
  reportLocation: 'Fundstelle',
  reportName: 'Dein Name',
  reportEmail: 'Deine E-Mail',
  reportChildAbuse: 'Die Meldung betrifft Darstellungen sexuellen Missbrauchs von Kindern (dann ohne Name und E-Mail möglich).',
  ...
  publishPending: 'Eingereicht am {date}. moinsen prüft den Eintrag; er erscheint nach der Freigabe.',
  publishApproved: 'Öffentlich in der Galerie.',
  publishOpen: 'Ansehen',
  publishRejected: 'Abgelehnt: {reason}',
  ...
  modLoad: 'Laden',
  modPending: 'Warten auf Freigabe ({n})',
  modReports: 'Meldungen ({n})',
  modApprove: 'Freigeben',
  modReject: 'Ablehnen',
  modRemove: 'Entfernen',
  modKeep: 'Bleibt online',
  modView: 'Ansehen',
  modReasonPrompt: 'Begründung (der Einreicher sieht sie im Studio):',
  modEmpty: 'Nichts zu tun.',
  modPaywall: 'Achtung: Quelle hinter Bezahlschranke, Einreichung ablehnen.',
  modReceipt: 'Eingang bestätigen',
} as const;
...
const EN: Record<MessageKey, string> = {
  ...
  galleryLead:
    'Submitted by the community, reviewed by moinsen. Every video plays live from its data. AI-researched, no guarantee of accuracy; the datasets are licensed CC BY-SA 4.0.',
  galleryFrom: 'From the public gallery: AI-researched, reviewed by moinsen, no guarantee of accuracy.',
  galleryEmpty: 'No entries yet. Yours can be the first: submit it in the studio under “Gallery”.',
  galleryLabel: 'AI-researched · reviewed by moinsen',
  galleryReport: 'Report',
  reportTitle: 'Report this entry',
  reportLead: 'What is wrong? For example wrong numbers, illegal or offensive content, or infringed rights. We review every report.',
  reportReason: 'Reason',
  reportLocation: 'Location',
  reportName: 'Your name',
  reportEmail: 'Your email',
  reportChildAbuse: 'This report concerns child sexual abuse material (then name and email are not required).',
  reportGoodFaith: 'I confirm in good faith that the information in this report is accurate and complete.',
  reportSend: 'Send report',
  reportThanks: 'Thanks, your report has been received.',
  close: 'Close',
  publishLead:
    'Show your video in the public gallery. Only the dataset is submitted: title, numbers, events, sources and the music parameters. No audio files, no keys, no personal data. moinsen reviews every submission before it appears.',
  publishRules: 'Gallery rules',
  publishRulesText:
    'Only content you may publish: nothing illegal, offensive or deliberately misleading, and no details about private individuals.\nThe sources must allow publication. Open data such as Our World in Data or the World Bank fits; numbers behind paywalls such as Statista do not.\nThe entry appears with all its sources and a note that an AI researched it.\nmoinsen may reject submissions or remove them later and tells you why, here in the studio.\nYou can withdraw your entry at any time; it is then deleted.',
  ...
  publishPending: 'Submitted on {date}. moinsen is reviewing the entry; it appears once approved.',
  publishApproved: 'Public in the gallery.',
  publishOpen: 'View',
  publishRejected: 'Rejected: {reason}',
  ...
  modToken: 'Admin token',
  modLoad: 'Load',
  modPending: 'Awaiting review ({n})',
  modReports: 'Reports ({n})',
  modApprove: 'Approve',
  modReject: 'Reject',
  modRemove: 'Remove',
  modKeep: 'Keep online',
  modView: 'View',
  modReasonPrompt: 'Reason (the submitter sees it in the studio):',
  modEmpty: 'Nothing to do.',
  modPaywall: 'Warning: paywalled source, reject this submission.',
  modReceipt: 'Confirm receipt',
};
